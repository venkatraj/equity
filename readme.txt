...
Equity is best suited for all types of site and uses Theme Customizer.
...
= Installation =
1. Download and unzip `equity` theme
2. Upload the `equity` folder to the `/wp-content/themes/` directory
...
11. Enter the contact form 7 shortcode if you want sliding form.
